...
public class AccountInfoServiceImpl implements AccountInfoService {
    ...
    public Long createAccount(CreateAccountReq req) {
        ...
        AccountFlowDo accountFlowDo = accountFlowService.createDeleteAccount(accountInfo,
                req.getAppId(),
                req.getOrderTime(),
                req.getTransId(),
                AccountFlowOperateTypeEnums.CREATE_ACCOUNT);
    ...
    public AccountInfoDo deleteAccount(DeleteAccountReq req) {
        ...
        AccountFlowDo accountFlowDo = accountFlowService.createDeleteAccount(accountInfoDo,
                req.getAppId(),
                req.getOrderTime(),
                req.getTransId(),
                AccountFlowOperateTypeEnums.DELETE_ACCOUNT);
        accountFlowRepository.insert(accountFlowDo);
